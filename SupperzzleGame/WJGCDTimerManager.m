...
@interface WJGCDTimerManager()
@property (nonatomic, strong) NSMutableDictionary *timerContainer;
@property (nonatomic, strong) NSMutableDictionary *actionBlockCache;
@property (nonatomic, strong) NSTimer *timer;
@end

@implementation WJGCDTimerManager

#pragma mark - Public Method

+ (WJGCDTimerManager *)sharedInstance
{
    static WJGCDTimerManager *_gcdTimerManager = nil;
    static dispatch_once_t onceToken;
    
    dispatch_once(&onceToken,^{
        _gcdTimerManager = [[WJGCDTimerManager alloc] init];
    });
